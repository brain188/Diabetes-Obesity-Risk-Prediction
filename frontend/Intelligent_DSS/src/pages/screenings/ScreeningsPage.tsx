...
import { Search, ClipboardPlus, Activity } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Select a patient to start or review a clinical screening session.
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description={search ? `No patients matching "${search}"` : "Register a patient to begin screening."}
        />
      ) : (
        <div className="space-y-2">
          {patients.map((patient) => (
            ...
            >
              ...
              <button
                onClick={() => navigate(`/patients/${patient.patient_id}/screening`)}
